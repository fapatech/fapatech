...
<body style="margin:0; font-family:Arial, sans-serif; background:#111; color:#eee;">
    ...
    <!-- CONTENT -->
    <div style="max-width:900px; margin:auto; padding:25px; background:#1a1a1a;">
    ...
    <!-- FOOTER -->
    <div style="background:#000; color:#aaa; text-align:center; padding:15px;">
